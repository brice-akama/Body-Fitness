...
const ListProduct = () => {
  ...
  // Handle SEO settings for a product
   const handleSeoSettingsClick = (productId) => {
    // Navigate to the SeoSettingsPage for the specific product
    navigate(`/seo-settings/${productId}`);
     // Logic to handle SEO settings, maybe opening a modal or redirecting to a SEO settings page
    toast.info(`SEO Settings for Product ID: ${productId}`);
        ...
        <table className="table-auto w-full bg-white shadow-md">
          <thead>
            <tr>
              ...
              <th className="p-4 border">SEO Settings</th> {/* Added SEO Settings column */}
            </tr>
          </thead>
          <tbody>
            {products.map((product) => (
              <tr key={product._id}>
                ...
                <td className="p-4 border">
                   {/* SEO Settings Button */}
          <button
            onClick={() => handleSeoSettingsClick(product._id)} // Trigger SEO settings for this product
